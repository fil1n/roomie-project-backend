...
import com.github.fil1n.models.Question;
    ...
    public void serialize(Group group, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        jsonGenerator.writeArrayFieldStart("polls");
            for(int i = 0; i < group.getPolls().size(); ++i) {
                ...
                jsonGenerator.writeNumberField("positive", question.getNumberOfAffirmativeAnswers());
                jsonGenerator.writeNumberField("negative", question.getNumberOfNegativeAnswers());
            }
